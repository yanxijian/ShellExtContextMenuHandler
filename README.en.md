...
- **Layered Gate architecture** (Extension / Item / Presentation) — see [docs/ARCHITECTURE.en.md](docs/ARCHITECTURE.en.md)
...
Shell COM glue stays thin; most customization is `config/menu.json` plus optional gates/executors. Details: [docs/ARCHITECTURE.en.md](docs/ARCHITECTURE.en.md).
