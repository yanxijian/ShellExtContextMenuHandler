...
HBITMAP BitmapFileIconProvider::LoadIcon(const std::wstring& iconSpec, UINT dpi, HINSTANCE module)
{
	...
	HBITMAP bitmap =
		static_cast<HBITMAP>(LoadImageW(nullptr, path.c_str(), IMAGE_BITMAP, iconSize, iconSize, LR_LOADFROMFILE | LR_LOADTRANSPARENT));
	if (bitmap == nullptr)
	{
