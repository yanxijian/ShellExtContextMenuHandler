...
public:
	...
	HRESULT Initialize(LPCITEMIDLIST pidlFolder, LPDATAOBJECT dataObject, HKEY hKeyProgID);
	...
	const std::vector<MenuItemDef>& GetCandidateItems() const
	{
		return m_candidateItems;
	}

private:
	void EnsureConfigLoaded();
	bool PassesTargetFilter(const MenuItemDef& item) const;
